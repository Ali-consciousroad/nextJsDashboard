...
export default function Search() {
  ...
  // Implement debouncing in the search component
  const handleSearch = useDebouncedCallback((term) => {
    ...
    // params.toString() translates this inout into a URL-friendly format.
  ...
  return (
    <div className="relative flex flex-1 flex-shrink-0">
      ...
      if we're using state to manage the value of an input, which is currently not the case, 
      we'd use the "value" attribute to make it a controlled component. 
      Here we use defaultValue which means the native input will manage its own state. */}     
      <input
